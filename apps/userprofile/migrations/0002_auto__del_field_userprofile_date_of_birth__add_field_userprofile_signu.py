...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.signup_date'
        db.add_column('userprofile_userprofile', 'signup_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.signup_date'
        db.delete_column('userprofile_userprofile', 'signup_date')
